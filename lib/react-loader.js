  ...
  var Loader = React.createClass({displayName: "Loader",
    ...
    render: function () {
      if (this.state.loaded) {
        return ( React.createElement("div", {key: "content", className: "loadedContent"}, this.props.children) );
      } else {
        return ( React.createElement("div", {key: "loader", ref: "loader", className: "loader"}) );
      }
    }
  });
